...
public class FPSController : PortalTraveller {
    ...
    void worldInteraction()
    {
        if (cam != null)
        {
            ...
            {
                RaycastHit hit;
                if (Physics.Raycast(cam.transform.position, transform.rotation * cam.transform.localRotation * Vector3.forward, out hit, interaction_range))
                {
